...
export async function setupGitHubSecrets(input) {
    ...
    console.error('[DEBUG] setupGitHubSecrets input:', JSON.stringify(args, null, 2));
    try {
...
//# sourceMappingURL=setup-github-secrets.mjs.map